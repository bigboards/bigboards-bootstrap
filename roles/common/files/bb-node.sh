...
# Default-Stop:         0 1 6
# Short-Description:    BigBoards API Server
# Description:          The NodeJS BigBoards API Server
### END INIT INFO
#
# Based on:
...
APPLICATION_DIRECTORY=/opt/bb/node/
APPLICATION_START="bbmm.js"
PIDFILE=/var/run/bb-node.pid
LOGFILE=/var/log/bb-node.log
